package hardcoder.dev.androidApp.ui.features.waterBalance.waterTrack.history
...
import hardcoder.dev.androidApp.ui.features.waterBalance.waterTrack.WaterTrackItem as WaterTrackItemRow
...
private fun WaterTracksHistory(
    ...
    if (waterTrackItems.isNotEmpty()) {
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Description(text = stringResource(id = R.string.waterTrackingHistory_emptyDayHistory_text))
    }
}
