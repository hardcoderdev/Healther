package hardcoder.dev.androidApp.ui.screens.user.creation
...
import hardcoder.dev.androidApp.ui.screens.user.GenderResourcesProvider
import hardcoder.dev.controller.input.ValidatedInputController
import hardcoder.dev.controller.request.RequestController
import hardcoder.dev.controller.selection.SingleSelectionController
import hardcoder.dev.logic.user.IncorrectUserExerciseStressTime
import hardcoder.dev.logic.user.IncorrectUserName
import hardcoder.dev.logic.user.IncorrectUserWeight
import hardcoder.dev.logic.user.ValidatedUserExerciseStressTime
import hardcoder.dev.logic.user.ValidatedUserName
import hardcoder.dev.logic.user.ValidatedUserWeight
...
private fun EnterNameSection(
    ...
    ValidatedTextField(
        ...
        validationAdapter = TextFieldValidationAdapter {
            if (it !is IncorrectUserName) {
                null
            } else {
                when (val reason = it.reason) {
                    is IncorrectUserName.Reason.Empty -> {
                        context.getString(R.string.errors_fieldCantBeEmptyError)
                    }

                    is IncorrectUserName.Reason.MoreThanMaxChars -> {
                        context.getString(
