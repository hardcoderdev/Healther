...
private fun CreateMoodTrackContent(
    ...
    Column(
        ...
        Column(
            ...
            SelectMoodSection(state = state, onUpdateMoodType = onUpdateMoodType, onManageMoodTypes = onManageMoodTypes)
        ...
        IconTextButton(
            ...
            labelResId = R.string.moodTracking_saveTrack_buttonText,
...
private fun EnterNoteSection(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        FilledTextField(
            ...
            label = R.string.moodTracking_saveTrack_enterNote_textField,
            multiline = true,
            maxLines = 5,
