...
class FeatureTypeIdMapper {
    ...
    private val map = mapOf(
        ...
        FeatureType.FOOD_TRACKING to FOOD_TRACKING_FEATURE_TYPE_ID,
    ...
    private companion object {
        ...
        private const val FOOD_TRACKING_FEATURE_TYPE_ID = 1
        private const val MOOD_TRACKING_FEATURE_TYPE_ID = 2
        private const val PEDOMETER_FEATURE_TYPE_ID = 3
