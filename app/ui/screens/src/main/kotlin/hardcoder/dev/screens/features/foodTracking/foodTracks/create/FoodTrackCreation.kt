package hardcoder.dev.screens.features.foodTracking.foodTracks.create
...
import hardcoder.dev.screens.features.foodTracking.foodTypes.observe.FoodTypeItem
...
@Composable
private fun FoodTrackCreationContent(
    caloriesInputController: InputController<Int>,
    dateTimeProvider: DateTimeProvider,
    dateTimeFormatter: DateTimeFormatter,
    foodSelectionController: SingleSelectionController<FoodType>,
...
@Composable
private fun FoodTrackCreationPreview() {
    HealtherTheme {
        FoodTrackCreation(
            onGoBack = {},
            onManageFoodTypes = {},
