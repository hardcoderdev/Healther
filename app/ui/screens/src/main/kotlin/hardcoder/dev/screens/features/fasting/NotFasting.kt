package hardcoder.dev.screens.features.fasting
...
import hardcoder.dev.screens.features.fasting.statistics.FastingStatisticSection
...
fun NotFasting(
    ...
    Column(
        ...
        Column(
            ...
            fastingStatistics?.let { statistic ->
        ...
        ScaffoldWrapper(
            ...
            content = {
                NotFasting(
                    ...
                    fastingStatistics = FastingMockDataProvider.fastingStatistics(),
